...
urlpatterns = [
    ...
    path('classes/<int:class_id>/attendance/sessions/<int:session_id>/challenge/', AttendanceCheckInChallengeView.as_view(), name='attendance_checkin_challenge'),
